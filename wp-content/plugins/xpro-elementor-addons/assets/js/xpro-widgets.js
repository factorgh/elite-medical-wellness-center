    ...
    let i = {
        init: function() {
            ...
            e.each(t, function(e, t) {
                ...
                a.id = "xpro-addons-wrapper-link-" + r, a.href = n.url, a.target = n.is_external ? "_blank" : "_self", a.rel = n.nofollow ? "nofollow noreferer" : "", a.style.display = "none", document.body.appendChild(a), (t = document.getElementById(a.id)).click(), i = setTimeout(function() {
        ...
        SimplePortfolio: function(t) {
            ...
            function f(i, o) {
                ...
                "false" !== (d = e(i).data("src-preview")) && (e(i).siblings().removeClass("xpro-preview-demo-item-open"), e(i).addClass("xpro-preview-demo-item-open"), t.find(".xpro-preview .xpro-preview-prev-demo,.xpro-preview .xpro-preview-next-demo").removeClass("xpro-preview-inactive"), e(i).prev("[data-src-preview]").length <= 0 && t.find(".xpro-preview .xpro-preview-prev-demo").addClass("xpro-preview-inactive"), e(i).next("[data-src-preview]").length <= 0 && t.find(".xpro-preview .xpro-preview-next-demo").addClass("xpro-preview-inactive"), t.find(".xpro-preview .xpro-preview-header-info").html(""), n && t.find(".xpro-preview .xpro-preview-header-info").append(`<div class="xpro-preview-demo-name">${n}</div>`), t.find(".xpro-preview .xpro-preview-iframe").attr("src", d), e("body").addClass("xpro-preview-active"), t.find(".xpro-preview").addClass("active"))
            }
        ...
        Counter: function(t) {
            let o = i.getElementSettings(t);
            "yes" === o.animate_counter && t.find(".xpro-counter-wrapper").elementorWaypoint(function() {
            ...
            if (t.find(".dropdown li").each(function(t) {
                    if (e("ul", this).length) {
                        let i = e("ul:first", this),
                            o;
                        i.offset().left + i.width() <= e(window).width() ? e(this).removeClass("xpro-edge") : e(this).addClass("xpro-edge")
                    }
                ...
                function s(i = !1) {
                    ...
                    t.find(".xpro-elementor-horizontal-navbar-nav li").each(function() {
                        ...
                        if (-1 !== l) {
                            ...
                            i && s.length && t.find(".xpro-elementor-horizontal-navbar-nav li:not(:first-child)").removeClass("current_page_item"), s.length && s.position().top - r <= n && s.position().top + s.height() > n && (t.find(".xpro-elementor-horizontal-navbar-nav li").removeClass("current_page_item"), o.addClass("current_page_item"))
                        }
                    })
                }
        ...
        Team: function(t) {
            let o = i.getElementSettings(t);
            if ("3" === o.layout && t.find(".xpro-team-layout-3").hover(function() {
                    e(this).find(".xpro-team-description").slideDown(200)
                }, function() {
                    e(this).find(".xpro-team-description").slideUp(200)
                }), "7" === o.layout && t.find(".xpro-team-layout-7").hover(function() {
                ...
                }), "8" === o.layout && t.find(".xpro-team-layout-8").hover(function() {
            ...
            "14" === o.layout && t.find(".xpro-team-layout-14").hover(function() {
                e(this).find(".xpro-team-description").slideDown(200), e(this).find(".xpro-team-social-list").slideDown(250)
            }, function() {
                e(this).find(".xpro-team-description").slideUp(200), e(this).find(".xpro-team-social-list").slideUp(250)
            })
        ...
        ContentToggle: function(t) {
            i.getElementSettings(t), t.find(".xpro-content-toggle-button").on("click", function(t) {
        ...
        Table: function(t) {
            ...
            t.find(".xpro-table-body-row").each(function(t, o) {
                e(o).find(".xpro-table-body-row-cell").each(function(t, o) {
        ...
        PostGrid: function(e) {
            ...
            e.find(".xpro-post-grid-item"), o.cubeportfolio({
                layoutMode: "grid",
                gridAdjustment: "responsive",
                lightboxGallery: !1,
                mediaQueries: [{
        ...
        HotSpot: function(t) {
            i.getElementSettings(t), t.find(".xpro-post-grid-main"), t.find(".xpro-hotspot-type-click").on("click", function(t) {
        ...
        ContactForm: function(t) {
            ...
            n.on("submit", function(i) {
                ...
                let s = n.serializeArray(),
                    ...
                    f = "",
                    u = 0;
                if (o.recaptcha && (a = t.find(".g-recaptcha-response").val()), e.each(s, function(e, i) {
                        "" !== i.value && "g-recaptcha-response" !== i.name && (p[u] = {
                            name: t.find("label[for=" + i.name.replaceAll("[]", "") + "]").text() || "",
                            value: i.value
                        }, u++)
                    }), p.length ? f = p.map(e => Object.entries(e).reduce((e, t, i) => `${e}${i>0?"&&":""}${t[0]}=${t[1]}`, "")) : d = !1, t.find('.xpro-contact-form-require [required="required"]').each(function(t) {
                        "" === e(this).val() && (d = !1)
                    }), !d) {
                ...
                t.find(".xpro-contact-form-message").slideUp(), e.ajax({
                    ...
                    e.success ? (c = '<div class="xpro-alert xpro-alert-success">' + o.success_message + "</div>", t.find(".xpro-contact-form-message").hide().html(c).slideDown()) : (c = '<div class="xpro-alert xpro-alert-danger">' + o.error_message + "</div>", t.find(".xpro-contact-form-message").hide().html(c).slideDown()), r.hide(), o.recaptcha && grecaptcha.reset()
                })
            })
        },
        Search: function(e) {
        ...
        ProductGrid: function(t) {
            ...
            t.find(".xpro-woo-product-grid-item"), t.find(".xpro-hv-qv-btn").click(function(i) {
                i.preventDefault();
                ...
                e.ajax({
                    ...
                    success: function(i) {
                        t.find("#xpro_elementor_fetch_qv_data").html(i), e(".xpro-woo-qv-content-sec .variations_form").wc_variation_form().find(".variations select:eq(0)").trigger("change"), e(".xpro-woo-qv-content-sec .variations_form").trigger("wc_variation_form")
                    }
                })
        ...
        HeroSlider: function(t) {
            ...
            new Swiper(t.find(".xpro-hero-slider")[0], {
                ...
                e(t.slides[t.activeIndex]).find("[data-animation]").each(function() {
                    var i = e(this),
                        o = "animated " + i.data("animation");
                    i.addClass(o).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                        i.removeClass(o)
