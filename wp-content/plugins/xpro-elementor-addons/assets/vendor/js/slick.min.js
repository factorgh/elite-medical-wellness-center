...
! function(i) {
    ...
    (s = (t = 0, function s(e, o) {
        ...
        var t, s, e, o = this,
            n = 0;
        return o.slideOffset = 0, s = o.$slides.first().outerHeight(!0), !0 === o.options.infinite ? (o.slideCount > o.options.slidesToShow && (o.slideOffset = -(o.slideWidth * o.options.slidesToShow * 1), n = -(s * o.options.slidesToShow * 1)), o.slideCount % o.options.slidesToScroll != 0 && i + o.options.slidesToScroll > o.slideCount && o.slideCount > o.options.slidesToShow && (i > o.slideCount ? (o.slideOffset = -((o.options.slidesToShow - (i - o.slideCount)) * o.slideWidth * 1), n = -((o.options.slidesToShow - (i - o.slideCount)) * s * 1)) : (o.slideOffset = -(o.slideCount % o.options.slidesToScroll * o.slideWidth * 1), n = -(o.slideCount % o.options.slidesToScroll * s * 1)))) : i + o.options.slidesToShow > o.slideCount && (o.slideOffset = (i + o.options.slidesToShow - o.slideCount) * o.slideWidth, n = (i + o.options.slidesToShow - o.slideCount) * s), o.slideCount <= o.options.slidesToShow && (o.slideOffset = 0, n = 0), !0 === o.options.centerMode && o.slideCount <= o.options.slidesToShow ? o.slideOffset = o.slideWidth * Math.floor(o.options.slidesToShow) / 2 - o.slideWidth * o.slideCount / 2 : !0 === o.options.centerMode && !0 === o.options.infinite ? o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2) - o.slideWidth : !0 === o.options.centerMode && (o.slideOffset = 0, o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2)), !1 === o.options.vertical ? t = -(i * o.slideWidth * 1) + o.slideOffset : !1 === o.options.verticalReverse ? t = -(i * s * 1) + n : (o.$slideTrack.css({
            display: "flex",
            "flex-direction": "column-reverse"
        }), t = -(o.slideCount * s * 1) + -(i * n) / o.options.slidesToShow), !0 === o.options.variableWidth && (e = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(i) : o.$slideTrack.children(".slick-slide").eq(i + o.options.slidesToShow), t = !0 === o.options.rtl ? e[0] ? -((o.$slideTrack.width() - e[0].offsetLeft - e.width()) * 1) : 0 : e[0] ? -1 * e[0].offsetLeft : 0, !0 === o.options.centerMode && (e = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(i) : o.$slideTrack.children(".slick-slide").eq(i + o.options.slidesToShow + 1), t = !0 === o.options.rtl ? e[0] ? -((o.$slideTrack.width() - e[0].offsetLeft - e.width()) * 1) : 0 : e[0] ? -1 * e[0].offsetLeft : 0, t += (o.$list.width() - e.outerWidth()) / 2)), t
        ...
        t.$slides.add(t.$slideTrack.find(".slick-cloned")).attr({
            ...
            var e = t.options.centerMode ? s : Math.floor(s / t.options.slidesToShow);
            !0 === t.options.dots && i(this).attr("aria-describedby", "slick-slide" + t.instanceUid + e)
        ...
        if (!0 === n.options.centerMode ? !0 === n.options.infinite ? o = (e = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), o = 2 + (n.options.slidesToShow / 2 + 1) + n.currentSlide) : (o = Math.ceil((e = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide) + n.options.slidesToShow), !0 === n.options.fade && (e > 0 && e--, o <= n.slideCount && o++)), t = n.$slider.find(".slick-slide").slice(e, o), "anticipated" === n.options.lazyLoad)
            for (var l = e - 1, d = o, a = n.$slider.find(".slick-slide"), c = 0; c < n.options.slidesToScroll; c++) l < 0 && (l = n.slideCount - 1), t = (t = t.add(a.eq(l))).add(a.eq(d)), l--, d++;
        r(t), n.slideCount <= n.options.slidesToShow ? r(s = n.$slider.find(".slick-slide")) : n.currentSlide >= n.slideCount - n.options.slidesToShow ? r(s = n.$slider.find(".slick-cloned").slice(0, n.options.slidesToShow)) : 0 === n.currentSlide && r(s = n.$slider.find(".slick-cloned").slice(-1 * n.options.slidesToShow))
        ...
        t = t || 1;
        var s, e, o, n, r, l = this,
            d = i("img[data-lazy]", l.$slider);
        d.length ? (e = (s = d.first()).attr("data-lazy"), o = s.attr("data-srcset"), n = s.attr("data-sizes") || l.$slider.attr("data-sizes"), (r = document.createElement("img")).onload = function() {
            o && (s.attr("srcset", o), n && s.attr("sizes", n)), s.attr("src", e).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === l.options.adaptiveHeight && l.setPosition(), l.$slider.trigger("lazyLoaded", [l, s, e]), l.progressiveLazyLoad()
        }, r.onerror = function() {
            t < 3 ? setTimeout(function() {
                l.progressiveLazyLoad(t + 1)
            }, 500) : (s.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), l.$slider.trigger("lazyLoadError", [l, s, e]), l.progressiveLazyLoad())
        }, r.src = e) : l.$slider.trigger("allImagesLoaded", [l])
        ...
        var t, s, e, o;
        s = this.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), this.$slides.eq(i).addClass("slick-current"), !0 === this.options.centerMode ? (t = Math.floor(this.options.slidesToShow / 2), !0 === this.options.infinite && (i >= t && i <= this.slideCount - 1 - t ? this.$slides.slice(i - t, i + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (e = this.options.slidesToShow + i, s.slice(e - t + 1, e + t + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === i ? s.eq(s.length - 1 - this.options.slidesToShow).addClass("slick-center") : i === this.slideCount - 1 && s.eq(this.options.slidesToShow).addClass("slick-center")), this.$slides.eq(i).addClass("slick-center")) : i >= 0 && i <= this.slideCount - this.options.slidesToShow ? this.$slides.slice(i, i + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : s.length <= this.options.slidesToShow ? s.addClass("slick-active").attr("aria-hidden", "false") : (o = this.slideCount % this.options.slidesToShow, e = !0 === this.options.infinite ? this.options.slidesToShow + i : i, this.options.slidesToShow == this.options.slidesToScroll && this.slideCount - i < this.options.slidesToShow ? s.slice(e - (this.options.slidesToShow - o), e + o).addClass("slick-active").attr("aria-hidden", "false") : s.slice(e, e + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")), ("ondemand" === this.options.lazyLoad || "anticipated" === this.options.lazyLoad) && this.lazyLoad()
        ...
        var i, t, s, e;
        if (i = this.touchObject.startX - this.touchObject.curX, (e = Math.round(180 * (s = Math.atan2(t = this.touchObject.startY - this.touchObject.curY, i)) / Math.PI)) < 0 && (e = 360 - Math.abs(e)), e <= 45 && e >= 0 || e <= 360 && e >= 315) return !1 === this.options.rtl ? "left" : "right";
        if (e >= 135 && e <= 225) return !1 === this.options.rtl ? "right" : "left";
        if (!0 === this.options.verticalSwiping) return !1 === this.options.verticalReverse ? e >= 35 && e <= 135 ? "down" : "up" : e >= 35 && e <= 135 ? "up" : "down";
        return "vertical"
